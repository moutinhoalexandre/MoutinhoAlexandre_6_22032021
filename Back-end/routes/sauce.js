...
const sauceLimiter = require('../middleware/sauceLimiter');//On appelle le middleware sauceLimiter


//Lier les routes aux controllers
router.post('/', auth, sauceLimiter, multer, sauceCtrl.createSauce);// C Créer une sauce
...
router.put('/:id', auth, sauceLimiter, multer, sauceCtrl.modifySauce);// U Modifier une sauce existante
